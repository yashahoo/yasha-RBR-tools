function [wtime] = WindArrows6a(u,v,wtime,begintime,numdays,interval,xtickhrs,ymax,ymax2)
...
% [wtime] = WindArrows6a(u,v,wtime,begintime,numdays,interval,xtickhrs,ymax,ymax2)
% inputs:
% 
...
% 
% OUTPUT:
% -wtime is time of wind in matlab datenum
% 
...
wticklab=datestr(wtime(1:dw:end),'dd-mmm ');
