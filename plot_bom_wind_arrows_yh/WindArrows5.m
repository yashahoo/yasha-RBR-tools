...
function WindArrows5(u,v,wtime,begintime,numdays,interval,xtickhrs,ymax)
...
% usage:
% 
% WindArrows5(u,v,wtime,begintime,numdays,interval,xtickhrs,ymax)
% 
% inputs:
% 
...
% find limits
ti_start =find(wtime> timestart,1,'first');
ti_end=find(wtime< timefinish,1,'last');
