...
%  [yh 20230404 redundant?]           p=p-10.1325; % remove mean atm pressure. It would be better if you had observations. I have them for this period but there are a few gaps so probably not best. If you are just calculating waves it doesnt matter.
            ...
            AnalysisMethod='zerocross' %'spectral';         % Wave calculation method. 'zerocross' or 'spectral'. use zerocross if you want Hs, but very similar to Hm0 and swell/sea are useful. Leave as spectral for this method
            fs=2;                             % instrument sample rate  in Hz
            site_depth=9.3576 %10;                      % approx depth of site (m) (seabed to surface)
            heightfrombed=0 %1 %8 ;%site_depth-1 ;  % [Default=0]   % height of instrument above bed (m). Only required if ocn.InputType='pressure' and ocn.AnalysisMethod='spectral'.If unknown assume = 0
