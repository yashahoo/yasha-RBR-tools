function [Eta Tr]=PcorZerocrossingFun_yh(input,fs,duration,h,heightfrombed,dispout)
%{
.. ++++++++++++++++++++++++++++++++YA LATIF++++++++++++++++++++++++++++++++++
.. +                                                                        +
.. + Oceanlyz                                                               +
...
.. +                                                                        +
.. ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 20220927 edited by yasha hetzel to output trend that was removed
...
.. code:: MATLAB
    ...
    [Eta Tr]=PcorZerocrossingFun(input,fs,duration,h,heightfrombed,dispout)
...
Tr                              Trend  timeseries at same locations that has been removed in the data which you can use to go back to the raw sea level
...
len=length(t(:,1));
% [input1]=detrend(input,'linear'); % original not used bc want to save the trend that was removed
%--------------------------------------------------------------------------
% yh edits
