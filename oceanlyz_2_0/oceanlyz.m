...
%                     wave.Field_Names = ['Hs, Hz, Tz, Ts, Field_Names, Burst_Data'];
                    ...
                    %yh add Hmax
                    [wave.Hmax(i,1), wave.Hs(i,1),wave.Hz(i,1),wave.Tz(i,1),wave.Ts(i,1),~,~]=WaveZerocrossingFun(input_data,obj.fs,obj.burst_duration,'off');
                    %[wave.Hs(i,1), wave.Ts(i,1), wave.Hz(i,1), wave.Tz(i,1), ~, ~, ~] = wavefromsurfaceelevzcross(input_data, obj.fs, 'no');
                    wave.Field_Names = ['Hmax','Hs, Hz, Tz, Ts, Field_Names, Burst_Data'];
...
% %                     
                     ...
                     %yh add Hmax
                    [wave.Hmax(i,1), wave.Hs(i,1),wave.Hz(i,1),wave.Tz(i,1),wave.Ts(i,1),~,~]=WaveZerocrossingFun((wave.Eta(i,:))',obj.fs,obj.burst_duration,'off');
                    wave.Field_Names = ['Eta, Hmax, Hs, Hz, Tz, Ts, Field_Names, Burst_Data'];
