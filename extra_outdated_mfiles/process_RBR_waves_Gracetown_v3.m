...
%%  settings
% dir_ref='/Volumes/Margs/RBRpressure_sensors/SN77825_Gracetown_Jan2016/'
% ncref='Gracetown_boatramp_077825_20160424_2037.nc'; instrument='SN077825';


% dir_ref='/Volumes/Margs/RBRpressure_sensors/SN124028_Gracetown_20180513/'
% ncref='124028_20180513_1011.nc'; instrument='SN124028';

% dir_ref='/Users/Yasha/Documents/RESEARCH/DATA/MEASURED/RBRpressure_sensors/SN124029_Gracetown_offshore20180519_1928/'
% ncref='SN124029_Gracetown_offshore20180519_1928.nc'
% instrument='124029';
% sample_rate_hz=2;
% max_period=25; % seconds
% begin=datenum(2018,1,14,9,30,0);
% finish=datenum(2018,2,27,12,10,0);


dir_ref='/Users/Yasha/Documents/RESEARCH/DATA/MEASURED/RBRpressure_sensors/SN124028_Gracetown_boatramp_20180513_1011/'
ncref='SN124028_Gracetown_boatramp20180513_1011.nc'

instrument='124028';
sample_rate_hz=2;
max_period=25; % seconds
begin=datenum(2018,1,13,18,0,0);
finish=datenum(2018,3,3,16,30,0);

% flag bad data with nans [if no bad data make badstart/end = NaN]
...
whereput=[dir_ref ncref(1:end-3) '_v2'];
mkdir(whereput);
%%
...
plot(ts,p,'r')
% % [x y]=ginput(1)
% x1=[round(6.4744e+03)  round(5.0928e+06)] % for sn124096
% goodi=[x1(1):x1(end)];
...
set(gca,'xlim',[ts(inds(1)) ts(inds(end))],'ylim',[-1 2]);
set(gca,'xticklabel',[]);
datetick('x','mm/dd HH:MM:SS','keeplimits')
% rotateXLabels( gca(), 90 )
