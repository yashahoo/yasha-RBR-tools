...
calculate_waves='ocn_toolbox' %'chari_method' % 'ocn_toolbox' % none (this will only save raw data)
...
%         5356800
        combined_ts = NaN(length(num_infiles)*24*3600*2,1);
        combined_p = NaN(length(num_infiles)*24*3600*2,1);
...
% % % %             p=p-10.1325; % remove mean atm pressure. It would be better if you had observations. I have them for this period but there are a few gaps so probably not best. If you are just calculating waves it doesnt matter.
            ...
            Disp('NOT CALCULATING WAVES--concatinating raw data!!!')        
                        try
        ...
        switch calculate_waves_both_methods
            ...
            case 'N'
                switch calculate_waves
                    ...
                    case 'none'
                        Disp('NOT CALCULATING WAVES -- SAVING RAW DATA ONLY!!!')   
