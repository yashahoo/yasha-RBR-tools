...
datum_correction= [NaN] ; site_depth=6;  location='Chari_new_rbr_test'; rawfile='/Volumes/Margs_Clone/RBRpressure_sensors/SN_206854_20230403_chari_new/206854_20230403_1218.rsk' % done
%%-------------------------------------------------------------------------%
...
OutputType='wave' %'wave+waterlevel'      % ['wave'], ['wave+waterlevel'];
